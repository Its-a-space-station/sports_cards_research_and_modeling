...
- **Expectations amendment 2 (2026-09-18):** the FG draft-board leg is **replaced by MLB Stats API `/draft/prospects/{year}`** — official JSON, no Cloudflare, draft-year ranks (2018–2025 ranked; 2015–2017 unranked player lists). Measured live: 2023 → 2,699 prospects with ranks 1–250. *Reason: mlb.com pages + fangraphs + archive.org were all rate-limiting this machine on 2026-09-18 (403 / Cloudflare / 429); Pipeline Top-100 capture is parked behind a periodic retry instead.*
